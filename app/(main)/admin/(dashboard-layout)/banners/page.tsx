...
const BannersPage: React.FC = () => {
  ...
  //? Render(s)
  const title = category_name ? `Banner Management - ${category_name}` : 'Banner Management'
  useTitle(title)
  const renderContent = () => {
            ...
            <table className="w-full whitespace-nowrap">
              <thead className="h-9 bg-emerald-50">
                <tr className="text-emerald-500">
                  ...
                  {category_name ? 'Banner Title' : 'Category Name'}
                  </th>
                  {category_name && <th className="border-gray-100 border-x-2">Type</th>}
