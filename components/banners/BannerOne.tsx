...
const BannerOne = ({ data }: BannerOneProps) => {

  //? Local components
  const BannerImage = ({ item, index }: { item: BannerOneProps['data'][0], index: number }) => <ResponsiveImage
    dimensions="h-[40vw] lg:h-72 w-full"
    className={`rounded-2xl overflow-hidden ${index === 0
