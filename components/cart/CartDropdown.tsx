...
export default function CartDropdown() {
  ...
  //? Store
  const { totalItems, cartItems, totalDiscount, totalPrice } = useAppSelector((state: RootState) => state.cart)
    ...
    <>
      ...
      >
        ...
        {totalItems > 0 ? (
          ...
          <p className="pt-2 text-base font-bold text-center">Your cart is empty!</p>
          </>
        )}
        </Menu.Items>
      </Transition>
