...
const BaseCheckbox = ({label, name, checked, onChange}: CheckboxProps, ref: React.Ref<HTMLInputElement>) => {
...
export const ControlledCheckbox = ({ name, control, ...restProps }: ControlledCheckboxProps) => {
