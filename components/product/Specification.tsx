...
const Specification = ({ specification }: SpecificationProps) => {
  ...
  return (
    <section className="px-4">
      <div className="lg:max-w-3xl xl:max-w-5xl">
        <h4 className="mb-3 h-fit w-fit lg:border-b-2 lg:border-red-500">Specifications</h4>
